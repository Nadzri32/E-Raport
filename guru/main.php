...
<body class="skin-purple hold-transition " 
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php $lkel=mysqli_query($con,"SELECT * FROM kelas order by kelas asc ");while($hlkel=mysqli_fetch_array($lkel)){ 
        ...
        <li <?php if(empty($_GET['r'])){}else if($_GET['q']==$hlkel['c_kelas']){echo 'class="active"';} ?>>
          <a href="#">
...
?>
  ...
  <footer class="main-footer">
   ...
   <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#"><?php echo $aplikasi['namasek']; ?></a></strong> by Rino Oktavianto
  </footer>
