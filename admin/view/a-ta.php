...
<?php $smk=mysqli_query($con,"SELECT * FROM tahunakademik order by tahun desc ");$vr=1;while($akh=mysqli_fetch_array($smk)){?>
                <tr>
                  ...
                  <td><?php if($akh['status']=='aktif'){ echo 'AKTIF';}else{?>
                    <span style="color: #d9534f;">TIDAK AKTIF</span> <small class="pull-right"><a class="btn btn-warning btn-xs" href="<?php echo $basead; ?>a-control/<?php echo md5('aktifkan').'/'.$akh['c_ta'].''; ?>">Aktifkan</a></small><?php } ?></td>
                  <td align="center">
                    ...
                    <a class="btn btn-circle btn-danger btn-sm" data-target="#hapus<?php echo $akh['c_ta']; ?>" data-toggle="modal"><i class="glyphicon glyphicon-remove"></i></a>
                    <?php } ?>
                  </td>
                </tr>
    ...
    <div class="modal-content">
      <div class="modal-header bg-green">
        ...
        <div class="modal-body">
          ...
          <b>1. Data Jumlah Nilai Dari Tahun Akademik Tersebut Akan Terhapus<br>2. Data Setting Rapot Dari Tahun Akademik Tersebut Akan Terhapus<br>3. Data Nilai Dari Tahun Akademik Tersebut Akan Terhapus<br>4. Data Ekstrakulikuler Siswa Dari Tahun Akademik Tersebut Akan Terhapus</b>
        </div>
        <div class="modal-footer">
