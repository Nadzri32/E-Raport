...
<div class="row">
  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
    ...
    <a href="<?php echo $basead; ?>mapel"><div class="info-box bg-aqua">
    ...
    <a href="<?php echo $basead; ?>mapel"><div class="info-box bg-fuchsia-active">
...
<?php $smk=mysqli_query($con,"SELECT * FROM kelas order by kelas asc ");$vr=1;while($akh=mysqli_fetch_array($smk)){?>                
  ...
  <?php 
      ...
      while($hsql=mysqli_fetch_array($sql)){ 
        $siswa=mysqli_fetch_array(mysqli_query($con,"SELECT nisn,nama from siswa where c_siswa='$hsql[c_siswa]' "));?>
                  <td><a href="<?php echo $basead; ?>search/<?php echo $siswa['nisn']; ?>"><?php echo $siswa['nama']; ?></a></td>
  <?php } } ?>
                </tr>
<?php $vr++; } ?>
          </tbody>
